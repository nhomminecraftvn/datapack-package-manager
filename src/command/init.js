...
module.exports.package = function package() {
    ...
    try {
        if (pack_name && !isNaN(pack_format) && description && pack_data && pack_version) cmdLib.initializePackage(pack_name, pack_format, description, pack_data, pack_author, pack_version);
